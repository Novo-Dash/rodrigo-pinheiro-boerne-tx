    ...
    <div>
      <div className="mb-3 flex items-center justify-between">
        <button
          ...
          className="flex h-[36px] w-[36px] items-center justify-center rounded-full text-[var(--color-text-muted)] hover:bg-[var(--color-bg-subtle)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent)]"
...
function DayCell({
  ...
  return (
    <button
      ...
      className={`mx-auto flex h-[36px] w-[36px] items-center justify-center rounded-full text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent)] ${
        selected
