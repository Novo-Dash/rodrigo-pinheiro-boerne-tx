...
import {
  ageHint, dateKey, fetchPrograms, groupPrograms, isWaitlist, longDate, noteOf, parseKey, shortName, timeLabel, type Program,
} from './programs'
...
type Options = { source?: string; audience?: Audience | null; copy?: Partial<Copy> }
...
export function BookingProvider({ children, source, audience, copy: pageCopy }: { children: ReactNode } & Options) {
  const [options, setOptions] = useState<Options | null>(null)
  const open = useCallback((o?: Options) => setOptions({ source, audience, copy: pageCopy, ...o }), [source, audience, pageCopy])
...
export function BookPage({ source, audience, copy: pageCopy }: Options) {
